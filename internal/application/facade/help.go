...
func (a *App) Help() string {
	return strings.Join([]string{
		...
		"home                   Return home (jumps back Hubble volumes, shifts back quantum, then travels)",
		...
		"jump                   Jump drive: thread a wormhole to the next timeline's Hubble volume",
		"jump back              Return to the previous timeline's Hubble volume",
		"universe               Shift forward to the next bubble universe",
		"universe back          Return to the previous bubble universe",
		"mathematical           Shift forward to the next mathematical structure",
...
func (a *App) Commands() []CommandInfo {
	return []CommandInfo{
		...
		{Name: "home", Description: "Return home, unwinding quantum branches and Hubble-volume jumps as needed"},
		...
		{Name: "jump", Description: "Jump drive: thread a wormhole to a distant Hubble volume sharing your location's geography but not its history"},
		{Name: "universe", Description: "Shift to the next bubble universe of your current location"},
		{Name: "mathematical", Description: "Shift to the next mathematical structure of your current location"},
