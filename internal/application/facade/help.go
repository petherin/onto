...
func (a *App) Help() string {
	return strings.Join([]string{
		...
		"cannot afford is refused and costs nothing. Your goal is to reach the target",
		"coordinate and return home; 'where' shows your remaining budget and objective",
		"status. Returning home is always allowed even if it overspends the budget.",
		"",
