...
func (a *App) suggestCommand(input string) string {
	...
	candidates := []string{cmdHelp, cmdWhere, cmdLook, cmdList, cmdRoute, cmdTravel, cmdHome, cmdCost, cmdShift, cmdJump, cmdUniverse, cmdDrift, cmdAlign, cmdObserve, cmdTime, cmdExit}
	best := ""
	bestDistance := math.MaxInt
